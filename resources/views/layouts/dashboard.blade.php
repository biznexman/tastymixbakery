 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">tasty M!X Bak3ry</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                ...
                                <div>Hello Ken, We delivered the Order number 487FT3BX to you yesterday, we will ...</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <div>
                                    <strong>Mercy Agatha</strong>
                                    <span class="pull-right text-muted">
                                        <em>LastWeek</em>
                                    </span>
                                </div>
                                <div>Let us know when we can make the next delivery, please remember to attach ...</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <div>
                                    <strong>Frank Obi</strong>
                                    <span class="pull-right text-muted">
                                        <em>LastWeek</em>
                                    </span>
                                </div>
                                <div>Thanks for your patronage, we always make it a point to give you the most ...</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        <li>
                            <a href="#">
                                <div>
                                    <i class="fa fa-money fa-fw"></i> 2 New Bills
